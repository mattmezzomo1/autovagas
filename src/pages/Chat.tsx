...
import { ArrowLeft, Search, Send, Paperclip, Image, Bot, Clock, CheckCircle2, Briefcase, MapPin, Building2, MoreVertical, Phone, Video, Calendar } from 'lucide-react';
...
export const Chat: React.FC = () => {
  ...
  const conversations: Conversation[] = [
    ...
    },
    {
      ...
      position: 'Tech Lead',
      lastMessage: 'Gostaríamos de agendar uma conversa...',
      lastMessageTime: new Date(),
      unreadCount: 0,
      isOnline: false,
    },
    {
      ...
      lastMessage: 'Seu perfil é exatamente o que procuramos...',
      lastMessageTime: new Date(),
      unreadCount: 1,
      isOnline: true,
    },
  ...
  const messages: Message[] = [
    {
      id: 1,
      sender: 'company',
      content: 'Olá! Gostamos muito do seu perfil e gostaríamos de conversar sobre a vaga de Desenvolvedor Full Stack Senior.',
      timestamp: new Date(),
      status: 'read',
    },
    {
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start">
                      <div className="truncate">
                        <div className="text-white font-medium">{conversation.companyName}</div>
          ...
          <div className="p-4 border-b border-white/10 bg-black/20 backdrop-blur-xl">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-white font-medium">TechCorp Inc.</h2>
